    ...
    <header className="fixed top-0 inset-x-0 z-50 backdrop-blur-md bg-background/70 border-b border-border/60">
      <div className="container flex items-center justify-between h-16">
        <a href="#home" className="flex items-center gap-2 font-display font-extrabold text-lg">
          <span className="text-xl font-bold text-foreground">Apex Stratum Heating Ltd</span>
          <span className="sr-only">Apex Stratum Heating Ltd & Heating</span>
        </a>
        ...
        <Button asChild variant="accent" size="sm" className="hidden sm:inline-flex">
          <a href="tel:+448001234567"><Phone className="w-4 h-4" /> 08001 234567</a>
        </Button>
      </div>
    </header>
  );
