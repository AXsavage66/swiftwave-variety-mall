...
const items = [
  ...
  { src: kitchenBoiler, alt: "New boiler fitted above kitchen worktop", label: "New boiler fitted above kitchen worktop" },
  { src: bathroom, alt: "Modern Manifold in the bathroomation in Battersea", label: "Manifold in the bathroom" },
